...
public class frmAplicacao extends javax.swing.JInternalFrame {
    ...
    public void popularTelaCadastro() {
        ...
        for (Class c : classes.subList(0, classes.size())) {
            if (aplicacao.getNomArquivoJava().equals(c.getCanonicalName())) {
                cmbAplicacaoNome.setSelectedItem(c.getCanonicalName());
            }
        }
    ...
    private void initComponents() {
        ...
        cmbAplicacaoNome = new javax.swing.JComboBox<>();
        ...
        cmbAplicacaoNome.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        cmbAplicacaoNome.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        lblNomeArquivo.setText("<html>Aplicação Nome<font color='red'><b>*</b></font>:</html>");
        ...
        pnlCadastroLayout.setHorizontalGroup(
            ...
            .addGroup(pnlCadastroLayout.createSequentialGroup()
                ...
                .addGroup(pnlCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cmbAplicacaoNome, 0, 290, Short.MAX_VALUE))
        ...
        pnlCadastroLayout.setVerticalGroup(
            ...
            .addGroup(pnlCadastroLayout.createSequentialGroup()
                ...
                .addGroup(pnlCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmbAplicacaoNome, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if ((Validacao.validarCampos(pnlCadastro) == 0)) {
            ...
            for (Class c : classes.subList(0, classes.size())) {
                if (cmbAplicacaoNome.getSelectedItem().toString().equals((c.getSimpleName()))) {
    ...
    private javax.swing.JComboBox<String> cmbAplicacaoNome;
